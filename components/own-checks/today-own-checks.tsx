    ...
    <div className="flex flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-7">
          ...
          {!pending.length && !deviations.length && !done.length && !result.backlog.length ? <Empty className="min-h-56"><EmptyHeader><EmptyMedia variant="icon"><ClipboardCheckIcon /></EmptyMedia><EmptyTitle>Ingen egenkontroller planlagt i dag</EmptyTitle><EmptyDescription>Der er ingen aktive kontroller for denne lokation.{canManage ? <> <Link href="/administration/own-checks" className="font-medium underline underline-offset-4">Administrér egenkontroller</Link></> : null}</EmptyDescription></EmptyHeader></Empty> : null}
