import { applyWorkfeedInstallation } from "./lifecycle";
...
export const setEnabledInternal = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    await writeInstallationState(ctx, args.organizationId, "workfeed", args.enabled, updatedAt);
    await applyWorkfeedInstallation(ctx, args.organizationId, args.enabled, updatedAt);
    return null;
  },
});
